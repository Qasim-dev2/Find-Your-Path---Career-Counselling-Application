...
public class fsciqController {
    ...
    int aarts;
    int commp;
    public void testscore(int score ,int medical,int perarts,int percomp)
    {
    ...
    private void initialize() {
        ...
        iqTest = new IQtest();
        questions = IQquestions.getIQQuestionsfor12();
    ...
    private void showResults() {
        ...
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("a10.fxml"));
            Parent root = loader.load();


            a10controller controller = loader.getController();


            controller.completescore((testscore+finalScore),mmedical,aarts,commp);
